...
See the following article for helping you get the Async CTP running on VS 2010 (all editions) – [http://mikaelkoskinen.net/post/async-ctp-fix-installation-problem.aspx](http://mikaelkoskinen.net/post/async-ctp-fix-installation-problem.aspx)
